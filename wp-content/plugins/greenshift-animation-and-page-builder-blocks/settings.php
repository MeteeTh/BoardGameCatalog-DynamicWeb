													...
													<div class="wp-block-greenshift-blocks-infobox gspb_infoBox gspb_infoBox-id-gsbp-158b5f3e-b35c" id="gspb_infoBox-id-gsbp-158b5f3e-b35c">
														<div class="gs-box notice_type icon_type">
															...
															<div class="gs-box-text">
																...
																<a target="_blank" href="<?php admin_url('/plugin-install.php?s=Greenshift%2520Smart%2520Code%2520AI&tab=search&type=term' . $stylebook_post_id . '&action=edit');?>" target="_blank"><?php esc_html_e("Download", 'greenshift-animation-and-page-builder-blocks'); ?></a>
															</div>
														</div>
													</div>
													<table class="form-table">
														...
														<tr>
															<td> <label for="css_system"><?php esc_html_e("Priority for Element Blocks in Inserter", 'greenshift-animation-and-page-builder-blocks'); ?></label> </td>
															<td>
